...
namespace Perfect_Scan_UWP.Materias
{
    public class Bundle
    {
        ...
        public static void VibrationScan(bool vibrate)
        {
            try
            {
                var vibrar = VibrationDevice.GetDefault();
                if (vibrate == true) vibrar.Vibrate(TimeSpan.FromSeconds(1)); 
            }
            catch { }
        }
